...
<!-- Tipo da página********************************************************  início conteúdo-->           	
                    ...
                    <div class="title-search-block">
                        <div class="title-block">
                            <div class="row">
                                <div class="col-md-6">
                                    <h3 class="title"> Cursos <a href="cursos_add.php" class="btn btn-primary btn-sm rounded-s">
						Adicionar
					</a>
                                        <!--
				 -->
							...
							Mais ações...
                                    ...
                                    <p class="title-description"> Lista com todos os cursos disponíveis na instituição </p>
                                </div>
                            </div>
                        </div>
