...
<!-- Tipo da página********************************************************  início conteúdo-->           	
                    ...
                    <div class="title-search-block">
                        <div class="title-block">
                            <div class="row">
                                <div class="col-md-12">
                                    <h3 class="title"> Disciplinas OPTATIVAS do curso:
                    ...
                    <div class="card items">
                                    ...
                                    <div class="item-col fixed pull-left item-col-title">
                                        ...
                                        <div>
                                            <a href="disciplinas-show.php" class="">
                                                <h4 class="item-title"> Todas disciplinas da UATI </h4>
                                            </a>
                                        </div>
                                    </div>
                            ...
                            <li class="item">
                                <div class="item-row">
                                    ...
                                    <div class="item-col fixed pull-left item-col-title">
                                        ...
                                        <div>
                                            <a href="disciplinas-show.php" class="">
                                                <h4 class="item-title"> Todas Disciplinas do PID</h4>
                                            </a>
                                        </div>
                                    </div>
                                    <div class="item-col item-col-sales">
                        ...
                        <div class="form-group row">
								...
								<div class="col-sm-10 col-sm-offset-2" style="padding-left:2%"> 
									<a href="cursos_show.php?busca=ultimo" class="btn btn-primary">Finalizar cadastro de curso</a>
