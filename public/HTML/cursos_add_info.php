...
<!-- Tipo da página********************************************************  início conteúdo-->           	
                    ...
                    <div class="title-block">
                        <h3 class="title"> Cadastrando informações adicionais no curso<span class="sparkline bar" data-type="bar"></span> </h3>
                    </div>
                    <form name="item">
                        <div class="card card-block">
							<div class="form-group row"> 
								...
								<div class="col-sm-10"> 
									<select class="c-select form-control boxed">
										<option selected>Selecione um atributo</option>
										<option value="1">Qnde de Bolsas</option>
							...
							<div class="form-group row">
								...
								<div class="col-sm-10 col-sm-offset-2"> 
									<a href="cursos_show.php" class="btn btn-primary">Gravar informação</a>
									<!--
