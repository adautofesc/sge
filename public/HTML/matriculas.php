				 ...
				 -->
                    ...
                    <div class="card items">
						...
						<span></span>
                                    ...
                                    <div class="item-col item-col-header item-col-sale">
							...
							<span></span>
									...
									<div class="item-col fixed pull-left item-col-sales">
                                        ...
                                        <div>
                                            <h4 class="item-title"> 24/07/2017 </h4>
                                        </div>
                                    </div>
                                    <div class="item-col fixed pull-left item-col-sales">
                                        <div class="item-heading">Aluno</div>
                                        <div>
                                            <a href="disciplinas_show.php" class="">
                                                <h4 class="item-title"> Adauto I. de Oliveira</h4>
                                            </a>
                                        </div>
                                    </div>
                                    <div class="item-col fixed pull-left item-col-sales">
