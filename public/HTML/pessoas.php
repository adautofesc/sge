...
<!-- Tipo da página********************************************************  início conteúdo-->           	
                    ...
                    <div class="title-search-block">
                        <div class="title-block">
                            <div class="row">
                                <div class="col-md-6">
                                    <h3 class="title"> Pessoas <a href="pessoas_add.php" class="btn btn-primary btn-sm rounded-s">
						Adicionar
					</a>
                                        <!--
				 -->
                                    ...
                                    <div class="item-col fixed pull-left item-col-title">
                                        ...
                                        <div>
                                            <a href="pessoas_show.php?id=1" class="">
                                                <h4 class="item-title"> Adauto Inocêncio de Oliveira Junior</h4>
                                            </a>
                                        </div>
                                    </div>
                                    <div class="item-col item-col-sales">
                                        <div class="item-heading">Nascimento</div>
                                        <div> 10/11/1984 (32)</div>
                                    </div>
                                    <div class="item-col item-col-sales">
                                        <div class="item-heading">Contato</div>
                                        <div> 16.9.9137.0041 </div>
                                    </div> 
                                    <div class="item-col item-col-sales">
                                        <div class="item-heading">Sexo</div>
                                        <div> M</div>
                                    </div> 
