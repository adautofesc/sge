...
<!-- Tipo da página********************************************************  início conteúdo-->           	
                    ...
                    <div class="title-search-block">
                        <div class="title-block">
                            <div class="row">
                                <div class="col-md-6">
                                    <h3 class="title"> Requisitos <a href="requisitos_add.php" class="btn btn-primary btn-sm rounded-s">
						Adicionar
					</a>
                                        <!--
				 -->
							...
							Mais ações...
                                    ...
                                    <p class="title-description"> Lista de requisitos de disciplinas </p>
                                </div>
                            </div>
                        </div>
						...
						<span></span>
							...
							<span></span>
                                    ...
                                    <div class="item-col fixed pull-left item-col-title">
                                        ...
                                        <div>
                                            <a href="requisitos_show.php" class="">
                                                <h4 class="item-title"> Exame médico atualizado</h4>
                                            </a>
                                        </div>
                                    </div>
                                    <div class="item-col item-col-sales">
                                        <div class="item-heading">Valor</div>
                                        <div> Verificação automática</div>
                                    </div>
                                    <div class="item-col item-col-sales">
							...
							<span></span>
                                    ...
                                    <div class="item-col fixed pull-left item-col-title">
                                        ...
                                        <div>
                                            <a href="requisitos_show.php" class="">
                                                <h4 class="item-title"> Certificado de Curso básico de informática 1</h4>
                                            </a>
                                        </div>
                                    </div>
                                    <div class="item-col item-col-sales">
							...
							<span></span>
                                    ...
                                    <div class="item-col fixed pull-left item-col-title">
                                        ...
                                        <div>
                                            <a href="requisitos_show.php" class="">
                                                <h4 class="item-title"> Aparelho de celular com número válido</h4>
                                            </a>
                                        </div>
                                    </div>
                                    <div class="item-col item-col-sales">
                                        <div class="item-heading">Valor</div>
                                        <div> Verificação manual</div>
                                    </div>
                                    <div class="item-col item-col-sales">
                                        <div class="item-heading">Tipo</div>
