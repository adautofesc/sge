...
<!-- Tipo da página********************************************************  início conteúdo-->           	
                    ...
                    <div class="title-block">
                        <h3 class="title"> Cadastrando novo Requisito para o curso de disciplinas<span class="sparkline bar" data-type="bar"></span> </h3>
                    </div>
                    <form name="item">
                        <div class="card card-block">
							...
							<div class="form-group row"> 
								...
								<div class="col-sm-10"> 
									<select class="c-select form-control boxed">
										...
										<option value="2">Recomendável</option>
									</select> 
								</div>
							</div>
							<div class="form-group row"> 
							...
							<div class="form-group row"> 
								...
								<div class="col-sm-4"> 
									<input type="text" class="form-control boxed" placeholder="código da regra de negócio"> 
								</div>
							</div>
							...
							<div class="form-group row">
								...
								<div class="col-sm-10 col-sm-offset-2"> 
									<a href="requisitos.php?busca=ultimo" class="btn btn-primary">Cadastrar requisito</a>
									<!--
