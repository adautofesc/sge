        ...
        <div class="col-md-4 center-block">
            <div class="card card-primary">
                ...
                <div class="card-block">
                    ...
                    <div>
                        <a href="/relatorios/tce-educadores"  target="_blank" class="btn btn-primary-outline col-xs-12 text-xs-left" title="Relatório contendo todos os Educadores, os respectivos cursos, cargas horárias previstas e efetivamente realizadas em 2018;">
                        <i class=" fa fa-arrow-right "></i>
                        &nbsp;&nbsp;Educadores</a>
                    </div>
                    <div>
