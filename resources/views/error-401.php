                    ...
                    <section class="section">
                        <div class="error-card">
                            ...
                            <div class="error-container">
                                <p>Que tal procurar em nosso sistema:</p>
                                <div class="row">
                                    <div class="col-xs-12">
			                ...
			                <button class="btn btn-primary" type="button">Buscar</button>
                                ...
                                </div> <br> <a class="btn btn-primary" href="javascript:history.back(-1)"><i class="fa fa-angle-left"></i> Voltar para página anterior</a> </div>
                        </div>
                    </section>
                </article>
                <footer class="footer">
