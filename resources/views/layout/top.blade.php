    			      ...
    			      <span class="counter">8</span>
                            ...
                            <li class="profile dropdown">
                                <a class="nav-link dropdown-toggle" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">
                                    <div class="img" style="background-image: url('http://thesocialmediamonthly.com/wp-content/uploads/2015/08/photo.png')"> </div> <span class="name">
    			      {{ Session::get('nome_usuario')}}Nome
    			    </span> 	</a>
