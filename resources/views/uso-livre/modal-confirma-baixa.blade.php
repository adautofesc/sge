    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="form-group row"> 
                    <h5 class="col-sm-12 form-control-label text-secondary text-xs-center title-description" >
                        Confirma a finalização de atendimento para os itens clicados/selecionados?
                    </h5>
                </div>
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-primary" data-dismiss="modal" onclick="modificarAtendimento('concluir');" >Confirmar</button>
